...
public class RepositorioHabilidadesLista implements RepositorioHabilidades {
    private Habilidade habilidade;
    private RepositorioHabilidadesLista proximo;

    public RepositorioHabilidadesLista(){
    ...
    public void inserir(Habilidade habilidade) {
        if(this.proximo == null){
            ...
            this.proximo = new RepositorioHabilidadesLista();
        }
        else {
